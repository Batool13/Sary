...
class Dimens {
  static const paddding10t = EdgeInsets.only(top: 10.0);
  static const paddding10all = EdgeInsets.all(10.0);
  static const paddding10tb = EdgeInsets.only(top: 10.0, bottom: 10);
  static const paddding10rl = EdgeInsets.only(right: 10.0, left: 10);
  static const paddding10trl =
      EdgeInsets.only(top: 10.0, right: 10.0, left: 10);
  static const paddding10brl =
      EdgeInsets.only(bottom: 10, right: 10.0, left: 10);
  static const paddding15t = EdgeInsets.only(top: 15.0);
  static const paddding15all = EdgeInsets.all(15.0);
  // static const paddding10tb = EdgeInsets.only(top: 10.0, bottom: 10);
  // static const paddding10rl = EdgeInsets.only(right: 10.0, left: 10);
